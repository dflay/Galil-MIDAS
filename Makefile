...
#
MODULES   = adccalib.o adcsum.o scaler.o movement.o
...
CC = gcc
CXX = g++
CFLAGS += -g -I$(INC_DIR) -I$(DRV_DIR) -I/home/galil/test 
LDFLAGS +=

all: $(UFE) analyzer

$(UFE): $(LIB) $(LIB_DIR)/mfe.o $(DRIVER).o $(UFE).c $(SRC_DIR)/cnaf_callback.c
	$(CXX) $(CFLAGS) $(OSFLAGS) -o $(UFE) $(UFE).c \
...
analyzer: $(LIB) $(LIB_DIR)/rmana.o analyzer.o $(MODULES) $(MODUL)
	$(CXX) $(CFLAGS) -o $@ $(LIB_DIR)/rmana.o analyzer.o $(MODULES) \
	$(LIB) $(LDFLAGS) $(ROOTLIBS) $(LIBS) $(MODUL)
